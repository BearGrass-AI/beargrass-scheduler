...
const MONO = 'font-family:ui-monospace,Menlo,Consolas,monospace;font-size:12.5px;line-height:1.45;color:#555;background:#f4f4f2;padding:10px 12px;border-radius:6px';
