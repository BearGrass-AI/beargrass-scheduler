...
<title>The Beargrass Scheduler, for agents</title>
...
<style>
  ...
  * { box-sizing:border-box }
  ...
  header img { width:170px; display:block }
...
<body>
<main>
  <header><a href="/"><img src="/wordmark-dark.svg" alt="BeargrassAI"></a><nav><a href="/agents.yaml">raw yaml</a><a href="/">the page for people</a><a href="https://github.com/BearGrass-AI/beargrass-scheduler">code</a></nav></header>
  <pre>${body}</pre>
