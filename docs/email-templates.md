...
Hand this email to your AI assistant and say "reply with when I'm free". It drafts, you send.
Or just reply with your free times, one per line:

    {{ex1}}, 2pm to 5pm
    {{ex2}}, 9am to noon
    {{ex3}}, all day
{{shot_option}}
Reply, not Reply All; only I see it. Times are read in {{zone_name}} unless you add a zone.
Nothing works? Reply "none". When everyone's in, you'll get one calendar invite.
...
Or reply with a screenshot of your calendar for those weeks; I'll read the gaps and show you what I read.
```
